...
/**
 Метод, отвечающий за приготовление заказа
 В методе есть 4 события, которые происходит случайным образом
 Если событие не случается, то счетчик увеличивается
